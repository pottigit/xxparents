...
class TestConfirmOrder():
    ...
    def setup(self):
        ...
        self.dbtable = "confirmOrder"
        self.payload = {}
        self.token_dbtable = "public_token"

        api_url = "http://192.168.0.215:8084/api/shopping/cart/confirm?"
    ...
    def testConfirmOrderSimpleData(self):
        """
        [confirmOrder] confirm order with a course data
        :return:
        """
        try:
    ...
    def testConfirmOrderMoreData(self):
        """
        [confirmOrder] confirm order with more course data
        :return:
        """
        try:
            self.conn = ConnectMongoDB(self.dbserver, self.dbport, self.dbdatabase, self.dbtable)
    ...
    def testConfirmOrderNotCourseid(self):
        """
        [confirmOrder] confirm order without courseid
        :return:
        """
        try:
            self.conn = ConnectMongoDB(self.dbserver, self.dbport, self.dbdatabase, self.dbtable)
    ...
    def testConfirmOrderNotUserid(self):
        """
        [confirmOrder] confirm order without userid
        :return:
        """
        try:
            self.conn = ConnectMongoDB(self.dbserver, self.dbport, self.dbdatabase, self.dbtable)
    ...
    def testConfirmOrderInvalidData(self):
        """
        [confirmOrder] confirm order with invalid courseid
        :return:
        """
        try:
            self.conn = ConnectMongoDB(self.dbserver, self.dbport, self.dbdatabase, self.dbtable)
